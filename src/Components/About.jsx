  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-xl">
          Hello! I am a Front-End Web Developer with over 7 years of experience
          ...
          Design, Web Frameworks (Bootstrap, Foundation), Email Marketing
          (Pardot, Hubspot, Vbout), and SEO tools (Google Analytics, Yoast SEO,
        ...
        <p className="pt-5 text-xl">
          ...
          Engine as well as analytics and data tools like Google Analytics, Hot
          Jar, and Data Dog, that ensure high performance and visibility for the
          websites I create.{" "}
        </p>
      </div>
    </div>
